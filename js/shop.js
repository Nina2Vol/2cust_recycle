...
// ////рассчитывать размеры канваса от блока, удалять модельку со сцены когда закрываешь модальное окно

// const shopPathModels = ['../models/product01.glb', '../models/product02.glb']; //догрузить!!!!!!
// const cards = document.querySelectorAll ('.card');
// //находим html-контейнер
// const shopBlock = document.querySelector('.product3d');
...
// renderer.setSize(window.innerWidth, window.innerHeight); //если что, здесь можно поменять на высоту и ширину блока попапа
// console.log (shopBlock.getBoundingClientRect());
// renderer.shadowMap.enabled = true;
// renderer.shadowMap.type = THREE.PCFSoftShadowMap;
// shopBlock.appendChild(renderer.domElement);

// const amLight = new THREE.AmbientLight(0xeeeeee)
// scene.add(amLight)

// const dirLight1 = new THREE.DirectionalLight(0xeeeeee, 1)
// dirLight1.position.set(-80, 1, 1)
// dirLight1.lookAt(1, 1, 0)
...
// //загружаем модели
// shopPathModels.forEach (path=>{
//     loader.load (path,(gltf)=>{
//         clothModel = gltf.scene;
//         clothModel.scale.set (1,1,1);
//         clothModel.castShadow = true;
//         clothModel.receiveShadow = true;
//         shopModels.push (clothModel);
